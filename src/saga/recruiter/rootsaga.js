...
import { watchGetAdvancedSearchEmployee, watchGetApplicantUser, watchGetApplicationsData,
   watchGetEndJobData, watchGetProfileAppli, watchGetRatingJob, watchPutProfileAppli, watchPutRatingJob } from 'saga/applicant/profileUpdateSaga';
...
,watchGetAdvancedSearchEmployee(),watchGetRatingJob(),watchGetEndJobData(),watchPutRatingJob(), watchGetApplicationsData()]);
}
